...
# with command line options: Configuration/GenProduction/python/BsToTauTau.py --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_upgrade2021_realistic_v5 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --step GEN,SIM --nThreads 16 --geometry DB:Extended --era Run3 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BsToTauTau.py nevts:1'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.bfilter+process.maindecayfilter+process.mufilter)
