...
# with command line options: miniAOD-prod -s PAT --eventcontent MINIAODSIM --runUnscheduled --mc --conditions auto:phase1_2021_realistic --era Run3 --no_exec --filein step3_inAODSIM.root --fileout miniaod_0.root --no_exec --customise_commands=process.packedPFCandidates.minPtForTrackProperties = 0.1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step3_inAODSIM.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('miniaod_0.root'),
