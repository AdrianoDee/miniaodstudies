...
# with command line options: Configuration/GenProduction/python/psi.py --conditions auto:phase1_2021_realistic -n 10 --era Run3 --eventcontent FEVTDEBUG --relval 9000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --geometry DB:Extended --fileout file:step1.root --no_exec --python_filename psi_2024.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/psi.py nevts:10'),
...
process.piplusfilter = cms.EDFilter("PythiaDauVFilter",
...
process.piminusfilter = cms.EDFilter("PythiaDauVFilter",
    ChargeConjugation = cms.untracked.bool(False),
    DaughterIDs = cms.untracked.vint32(-211),
    MaxEta = cms.untracked.vdouble(2.4),
    MinEta = cms.untracked.vdouble(-2.4),
...
process.psi2SIDfilter = cms.EDFilter("PythiaFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.psi2SIDfilter+process.jpsifilter+process.muminusfilter+process.muplusfilter+process.piminusfilter+process.piplusfilter)
