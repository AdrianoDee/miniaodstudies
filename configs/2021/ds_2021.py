...
# with command line options: Configuration/GenProduction/python/dstar.py --conditions auto:phase1_2021_realistic -n 10 --era Run3 --eventcontent FEVTDEBUG --relval 9000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --geometry DB:Extended --fileout file:step1.root --no_exec --python_filename ds_2024.py
...
process.DstarFilter = cms.EDFilter("PythiaMomDauFilter",
    ...
    MomMinPt = cms.untracked.double(0.5),
