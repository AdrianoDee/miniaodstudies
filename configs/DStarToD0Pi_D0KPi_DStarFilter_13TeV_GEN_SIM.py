...
# with command line options: Configuration/GenProduction/python/TRK-RunIIWinter19PFCalib17GS-00017-fragment.py --conditions auto:phase1_2021_realistic -n 10 --era Run3 --eventcontent FEVTDEBUG --relval 9000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --geometry DB:Extended --fileout file:step1.root --no_exec --python_filename DStarToD0Pi_D0KPi_DStarFilter_13TeV_GEN_SIM.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('D* -> D^0 Pi, with D0 -> K Pi, 13 TeV, TuneCP5'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/EvtGenInterface/data/Dstar_D0_Kpi.dec')
        ),
