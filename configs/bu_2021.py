...
# with command line options: Configuration/GenProduction/python/bu.py --conditions auto:phase1_2021_realistic -n 10 --era Run3 --eventcontent FEVTDEBUG --relval 9000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --geometry DB:Extended --fileout file:step1.root --no_exec --python_filename bu_2021.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/bu.py nevts:10'),
...
process.decayfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    MinPt = cms.untracked.vdouble(5.0, 0.4),
...
process.xxxfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    MinPt = cms.untracked.vdouble(5, 0.3, 0.3),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.bfilter+process.jpsifilter+process.xxxfilter+process.decayfilter)
